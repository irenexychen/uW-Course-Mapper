    ...
    for year in range (2017, 2018):
        ...
        for month in range (1, 2):
            ...
            for day in range (1, 2):
                ...
                next_elementFund = browser.find_element_by_xpath("//input[@name='txtFundName']/following-sibling::input")
                next_elementFund.send_keys("TD U.S. Blue Chip Equity Fund - Investor Series")
                #elementFund.send_keys("TD U.S. Blue Chip Equity Fund - Investor Series")
                print(next_elementFund.get_attribute('value'))
                sleep(5)
                #button = browser.find_element_by_name('btnName')
                button = browser.find_element_by_xpath("//input[@name='btnName']")
